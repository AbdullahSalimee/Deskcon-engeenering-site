<section class="bg-primary-700 text-primary-500 py-8 md:py-20 px-4 md:px-16">
	<div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
		<div>
			<h1 class="text-2xl sm:text-3xl md:text-5xl font-bold md:my-6 leading-tight">
				Mechanical Equipment Design &<br />Detail Engineering
			</h1>
			<p class="text-lg text-lightBlue md:my-4 leading-relaxed">
