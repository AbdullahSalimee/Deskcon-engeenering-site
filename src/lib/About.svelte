			...
			<div class="space-y-8">
				<div class="prose prose-lg max-w-none text-primary-900">
					<p class="text-xl leading-relaxed">
						...
						specializing in Mechanical, Civil, and Electrical projects, with particular focus on the
						oil and gas sector.
					</p>
					<p class="leading-relaxed">
						Our team of highly skilled professionals delivers comprehensive designs, ensuring every
						project is executed with precision. From Front-End Engineering Design to detailed
						engineering, we maintain excellence across all aspects of mechanical, civil/structural,
					...
					<p class="leading-relaxed">
						Our commitment to client satisfaction and tailored approach sets us apart. We understand
						our clients' unique challenges and add significant value at every project stage. With a
						proven track record, we build long-term partnerships based on trust, reliability, and
