...
<section id="projects" class="bg-primary-500 py-24 px-4 md:px-16">
...
<a
href="tel:+923004885588"
class="mt-8 px-8 py-3 bg-primary-300 text-primary-900 cursor-pointer font-semibold rounded-full hover:bg-primary-200 transition duration-300 inline-flex items-center"
aria-label="Call us at +92 300 4885588"
>
Call us Now
<svg 
  class="w-5 h-5 ml-2" 
